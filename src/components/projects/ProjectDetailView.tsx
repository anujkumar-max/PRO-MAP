...
import type { Assignment, ProjectHealth } from '@/types';
    ...
    <div className="p-6 md:p-8 text-white min-h-screen">
      ...
      {activeTab === 'flow' && (
        <div className="bg-slate-800/20 border border-slate-700 rounded-xl p-8 text-center">
          <p className="text-slate-300 mb-4">View the interactive hierarchy &amp; operational staff flow diagram for {project.name}.</p>
          <Link 
            href={`/flow/${id}`}
          ...
          >
            <GitBranch className="w-5 h-5" /> Open Full Flow Diagram
          </Link>
        </div>
      )}
